    ...
    { -- colorscheme catppuccin
        ...
        keys = {
            {
                ...
                silent = true,
                noremap = true,
                desc = 'Show sidebar with lsp symbols'
            }
        },
        init = function()
            vim.g.vista_default_executive = 'nvim_lsp'
            vim.g.vista_sidebar_width = 50
            vim.g.vista_executive_for = {cpp = 'nvim_lsp', rs = 'nvim_lsp'}
        end
    }, { -- toggle terminal
        ...
        config = function()
            ...
            function _G.set_terminal_keymaps()
                ...
                vim.api.nvim_buf_set_keymap(0, 't', '<leader><esc>', [[<C-\><C-n>]],
                                            opts)
                vim.api.nvim_buf_set_keymap(0, 't', '<C-Left>',
                                            [[<C-\><C-n><C-W>h]], opts)
                vim.api.nvim_buf_set_keymap(0, 't', '<C-Right>',
                                            [[<C-\><C-n><C-W>l]], opts)
            end
        ...
        keys = {
            {
                ...
                silent = true,
                noremap = true,
                desc = 'Show diagnostics messages in sidebar window'
            }
        },
        opts = {
            win = {
        ...
        keys = {
            {
                ...
                mode = {'n', 'i'},
                desc = 'Show file tree in sidebar'
            }
        },
        opts = {
